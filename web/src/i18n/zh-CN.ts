export default {
  ...
  settings: {
    ...
    irSection: {
      learnTitle: '学习新命令',
      learnDesc: '把遥控器对准板上接收头，按住目标按键约 1 秒',
      buttonName: '按键名称',
      buttonNamePlaceholder: '例如：客厅电视-电源',
      parentRemote: '所属遥控',
      newRemote: '新建遥控…',
      newRemoteNamePlaceholder: '输入新遥控名称，如：客厅电视',
      startLearn: '开始学习',
      cancelLearn: '取消学习',
      ...
      errorRemoteName: '请填写新遥控名称或选择已有遥控',
      errorTimeout: '学习超时：未捕捉到红外信号',
      errorFailed: '学习过程中发生错误',
      myCommandsTitle: '我的命令',
      myCommandsDesc: '发射测试、绑定槽位、改名与删除',
      noRemotesYet: '还没有学习任何遥控，先从上方“学习新命令”开始。',
      ...
      libraryTitle: '模板库',
      libraryDesc: '导入他人分享的遥控包，一键获得整套按键',
      importPack: '导入遥控包',
      importResult: '导入完成：{remotes} 个遥控、{buttons} 个按键（跳过重复 {skipped} 个）',
      libraryHint: '遥控包为 JSON 文件（*.onekvm-ir.json），包含一个遥控的全部按键码，可在“我的命令”中导出分享。',
      hwTitle: '硬件设置',
