export default {
  ...
  settings: {
    ...
    ir: 'IR Remote',
    irSection: {
      newRemoteTitle: 'New Remote',
      newRemoteDesc: 'Create a remote (e.g. "Living room TV") first, then learn its buttons in the library below',
      newRemotePlaceholder: 'Remote name, e.g. Living room TV',
      createRemote: 'Create remote',
      learnButton: 'Learn a button',
      buttonNamePlaceholder: 'Button name, e.g. Power',
      startLearn: 'Start learning',
      cancelLearn: 'Cancel',
      stateWaiting: 'Waiting for IR signal… hold the remote button',
      stateSaved: 'Saved successfully',
      stateFailed: 'Learn failed',
      errorButtonName: 'Enter a button name first',
      errorTimeout: 'Learn timed out: no IR signal captured',
      errorFailed: 'An error occurred while learning',
      noRemotesYet: 'The library is empty — start with "New Remote" above or import a remote pack.',
      noButtonsInRemote: 'No buttons in this remote yet',
      sendTest: 'Test transmit',
      slotBind: 'Bind slot',
      slotNone: 'Unbound',
      slotN: 'Slot {n}',
      slotPending: '{n} unsaved slot change(s)',
      slotSave: 'Save changes',
      slotRevert: 'Revert',
      slotSaved: 'Slot changes saved',
      kvmActive: 'KVM Switch active',
      kvmMakeActive: 'Set as KVM Switch',
      kvmSetDone: '"{name}" is now the KVM Switch remote',
      slotOnlyKvm: 'Only the KVM Switch remote can bind slots',
      confirmDeleteRemote: 'Delete remote "{name}" and all of its buttons?',
      confirmDeleteButton: 'Delete this button?',
      libraryTitle: 'Remote Library',
      libraryDesc: 'Learned remotes and buttons: test transmit, bind slots, rename, delete, import and share',
      export: 'Export remote pack',
      importPack: 'Import remote pack',
      importResult: 'Import finished: {remotes} remotes, {buttons} buttons ({skipped} duplicates skipped)',
      libraryHint: 'A remote pack is a JSON file (*.onekvm-ir.json) holding every button code of one remote. Export any remote via its download icon to share.',
      hwTitle: 'Hardware',
      hwDesc: 'Transmit GPIO and learning parameters',
      hwReceiver: 'IR receiver',
      hwTransmitter: 'IR transmitter',
      hwLed: 'Status LED (WS2812)',
      enableFeature: 'Enable IR remote feature',
      rxDevice: 'Receiver device',
      txMode: 'Transmit mode',
      txModeAuto: 'Auto',
      txModeLirc: 'Kernel LIRC device',
      txModeGpio: 'Direct GPIO drive',
      txModeNone: 'Disabled',
      txGpioChip: 'TX GPIO chip',
      txGpioLine: 'TX GPIO line',
      carrier: 'Carrier frequency (Hz)',
      learnTimeout: 'Learn timeout (ms)',
      ledEnabled: 'Enable STA status LED',
      ledBrightness: 'LED brightness',
      ledHint: 'Learning=green blink, saved=blue, failure=red',
    },
    ...
    irSubtitle: 'Learn, transmit and share IR remote buttons',
