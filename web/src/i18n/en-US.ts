export default {
  ...
  settings: {
    ...
    ir: 'IR Remote',
    irSection: {
      learnTitle: 'Learn a New Command',
      learnDesc: 'Point the remote at the on-board receiver and hold the button for about 1 second',
      buttonName: 'Button name',
      buttonNamePlaceholder: 'e.g. Living room TV - Power',
      parentRemote: 'Remote',
      newRemote: 'New remote…',
      newRemoteNamePlaceholder: 'Enter a new remote name, e.g. Living room TV',
      ...
      errorRemoteName: 'Enter a new remote name or pick an existing one',
      errorTimeout: 'Learn timed out: no IR signal captured',
      errorFailed: 'An error occurred while learning',
      myCommandsTitle: 'My Commands',
      myCommandsDesc: 'Test transmit, bind slots, rename and delete',
      noRemotesYet: 'No remotes yet — start with "Learn a New Command" above.',
      ...
      libraryDesc: 'Import remote packs shared by others to get a full set of buttons at once',
      importPack: 'Import remote pack',
      importResult: 'Import finished: {remotes} remotes, {buttons} buttons ({skipped} duplicates skipped)',
      libraryHint: 'A remote pack is a JSON file (*.onekvm-ir.json) holding every button code of one remote. Export yours from "My Commands" to share.',
      hwTitle: 'Hardware',
